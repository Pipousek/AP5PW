...
using UTB.Eshop.Nagy.Web.Areas.Security.Controllers;
using UTB.Eshop.Nagy.Web.Controllers;
using UTB.Eshop.Nagy.Web.Models.ApplicationServices.Abstraction;
using UTB.Eshop.Nagy.Web.Models.ViewModels;
using UTB.Eshop.Nagy.Tests.Helpers;

namespace UTB.Eshop.Nagy.Tests
{
